    ...
    <>
      ...
      <div>
        <motion.button
          ...
          onClick={handleClick}
          className="sm:right-4 sm:bottom-20 rounded-full flex text-white flex-col fixed right-14 bottom-6 z-20 bg-black px-6 py-4 cursor-pointer hover:bg-yellow-600 duration-700 ease-in-out"
        >
          <svg
